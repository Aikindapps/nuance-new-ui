...
export function Tab({ to, end, children }: TabProps) {
  return (
    <NavLink
      ...
      className={({ isActive }) =>
        [
          "relative flex items-center justify-center px-6 py-3 text-body transition-colors rounded-sm focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-brand-purple",
          isActive
