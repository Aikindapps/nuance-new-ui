        ...
        <MyArticlesMobileList
          ...
          deletingId={
            deleteMutation.isPending
              ? (deleteMutation.variables?.postId ?? null)
              : null
          }
          unpublishingId={
            unpublishMutation.isPending
              ? (unpublishMutation.variables?.postId ?? null)
              : null
          }
        />
      </div>
      {/* Desktop layout: visible at lg+ -- byte-identical to the original */}
