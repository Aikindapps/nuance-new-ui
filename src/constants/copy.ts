...
export const writeArticleCopy = {
  ...
  publish: {
    ...
    titleSubmitForReview: "Submit for review",
...
export const manageSubscriptionsCopy = {
  ...
  amountLabel: "Price",
  unit: "NUA",
  paymentHeading: "Payment address",
  paymentSectionHelp: "The wallet principal that receives this publication's share of subscription revenue.",
  paymentFieldLabel: "Receiving principal",
  paymentPlaceholder: "Enter the principal that receives payments",
  paymentHelperDefault: "Must be a valid ICP principal ID.",
  paymentHelperRequired: "Required. Enter a valid ICP principal ID.",
  paymentSplitHelp: "Nuance retains a 10% platform fee. The remainder is split between this address and the writer, per the split set at publication setup.",
